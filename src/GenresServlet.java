...
//                    String[] words = inputTitle.split(" ");
//
//                    // Start building the fuzzy search conditions
//                    titleCondition += "AND (";
//
//                    for (String word : words) {
//                        // Add OR conditions for each word
//                        titleCondition += "title LIKE '%" + word + "%' OR ";
//                    }
//
//                    // Remove the trailing " OR "
//                    titleCondition = titleCondition.substring(0, titleCondition.length() - 4);
//
//                    // Add the fuzzy search conditions
//                    titleCondition += " OR edth('" + inputTitle + "', title) <= " + fuzzySearchThreshold + " OR SOUNDEX('" + inputTitle + "') = SOUNDEX(title)) ";
//
//
//                }

//                if (inputTitle != null && inputTitle != "") {
//                    titleCondition = " AND movies.title LIKE ?";
//                    inputTitle = "%" + inputTitle + "%";
//                    searchCondition.add(inputTitle);
//                    conditionCount++;
//                }
...
//                    if (inputTitle != null && inputTitle != "") {
//                        statement.setString(paramIndex, inputTitle);
//                        paramIndex++;
//                    }
